...
static void CG_PlayerFootsteps( centity_t *const cent, footstepType_t footStepType )
{
		...
		&& cent->gent->client->NPC_class != CLASS_SWAMP )
	{
		...
		_PlayerFootStep( sideOrigin, footDownDir, cent->pe.legs.yawAngle, 6, cent, footStepType );	//was cent->pe.legs.yawAngle-90 //no reason now to turn footprint angle 90 degrees
	}
}
